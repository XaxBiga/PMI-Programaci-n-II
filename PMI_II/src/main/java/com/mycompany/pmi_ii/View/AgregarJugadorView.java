 ...
 * @author Usuario
 */
public class AgregarJugadorView extends javax.swing.JFrame {
    /**
     * Creates new form AgregarJugador
     */
    public AgregarJugadorView() {
        initComponents();
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarJugadorView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgregarJugadorView().setVisible(true);
            }
        });
    }
